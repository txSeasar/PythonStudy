# -*- coding: utf-8 -*-
"""
Created on Wed Aug 22 08:53:00 2018
...
flags.DEFINE_string('ps_hosts', '172.16.32.192:22221,172.16.60.213:22221', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', '172.16.60.214:22221,172.16.60.215:22221',
                    'Comma-separated list of hostname:port pairs')
# 设置job name参数
flags.DEFINE_string('job_name', 'worker', 'job name: worker or ps')
# 设置任务的索引
flags.DEFINE_integer('task_index', '1', 'Index of task within the job')
# 选择异步并行，同步并行
flags.DEFINE_integer("issync", '1', "是否采用分布式的同步模式，1表示同步模式，0表示异步模式")
